...
public class ApplyEnumDialog extends DataTypeSelectionDialog {
	...
	protected JComponent createEditorPanel(DataTypeSelectionEditor dtEditor) {
		...
		updatedPanel.setBorder(GhidraBorderFactory.createEmptyBorder(5, 10, 10, 0));
		...
		subOpCB.setBorder(GhidraBorderFactory.createEmptyBorder(0, 20, 0, 0));
		...
		label.setBorder(GhidraBorderFactory.createEmptyBorder(5, 0, 5, 0));
